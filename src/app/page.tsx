...
export const metadata = {
  ...
  description: "Hi, I’m Sahil a Full Stack Developer with a passion for building seamless, intuitive applications that make technology accessible and enjoyable.",
  keywords: ["Sahil", "Portfolio", "Next.js Developer", "Frontend Developer", "Projects"],
  authors: [{ name: "Sahil" }],
  openGraph: {
    title: "Sahil | Portfolio",
    description: "Hi, I’m Sahil a Full Stack Developer with a passion for building seamless, intuitive applications that make technology accessible and enjoyable.",
