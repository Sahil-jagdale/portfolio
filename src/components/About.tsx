    ...
    <div>
      <div className="pt-16">
        ...
        <div className="pt-2 text-neutral-400/80">
          <div>
            hyyyyyy I’m
            <span className="text-white/85"> Sahil — a 22yo Developer</span> from Pune with a
            passion for building seamless, intuitive applications that make
            technology accessible and enjoyable.
            <div className="pt-3">
              I started my dev journey back in College (<span className="text-white/85">bit late •︵•</span>). Since then, im
              <span className="text-white/85">
                {" "}
                exploring the tech
              </span> continuously. This
